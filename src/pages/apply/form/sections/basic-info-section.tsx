      ...
      <div className="rounded-[20px] bg-bg-muted px-5">
        ...
        <section className="mt-8">
          ...
          <div className="mt-6 space-y-6">
            <div ref={applicantNameRef}>
              <label className="block text-sm font-semibold text-text-default">이름<span className="ml-1 text-point">*</span></label>
              <input
            ...
            <div ref={departmentRef}>
              <label className="block text-sm font-semibold text-text-default">학과<span className="ml-1 text-point">*</span></label>
              <input
            ...
            <div ref={studentNoRef}>
              <label className="block text-sm font-semibold text-text-default">학번<span className="ml-1 text-point">*</span></label>
              <input
            ...
            <div ref={gradeRef}>
              <label className="block text-sm font-semibold text-text-default">학년<span className="ml-1 text-point">*</span></label>
            ...
            <div ref={phoneRef}>
              <label className="block text-sm font-semibold text-text-default">전화번호<span className="ml-1 text-point">*</span></label>
              <input
                value={form.phone}
            ...
            <div ref={genderRef} className="flex items-center gap-6">
              <span className="shrink-0 text-sm font-semibold text-text-default">성별<span className="ml-1 text-point">*</span></span>
        ...
        <section className="mt-12">
          ...
          <div ref={codingExpRef} className="mt-6">
            <p className="text-sm font-semibold text-text-default">코딩 경험<span className="ml-1 text-point">*</span></p>
        ...
        <section className="mt-8">
          ...
          <div className="mt-6 space-y-6">
            <div ref={aspirationRef}>
              <label className="block text-sm font-semibold text-text-default">포부<span className="ml-1 text-point">*</span></label>
              <textarea
