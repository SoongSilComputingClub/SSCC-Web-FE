...
export const CONSENT_CONTENT = {
  ...
  purposes: [
    "SSCC 신입 부원 선발 및 지원자 관리",
    "합격 여부 안내 및 동아리 운영 관련 연락",
  ],
  retentionTitle: "보유 및 이용 기간",
  retention:
    "동아리 선발 절차 종료 후 1년 이내 (단, 합격자의 경우 동아리 활동 기간 동안 보관)",
  ...
  return (
    <div className="w-full max-w-[560px] mx-auto flex flex-col gap-4">
      ...
      <div className="rounded-[20px] bg-bg-section px-5 py-6">
        <h2 className="text-point text-lg font-bold text-center">
          {CONSENT_CONTENT.title}
        </h2>

        {/* 세부 내용 */}
        <div className="mt-4 w-full rounded-[20px] bg-bg-default border border-border-default shadow-[8px_8px_4px_0_rgba(0,0,0,0.25)] px-5 py-4">
          <div className="text-xs text-text-default/90 leading-relaxed">
            <p>{CONSENT_CONTENT.intro}</p>

            <div className="mt-4">
              <p className="font-semibold text-text-default">
                ■ {CONSENT_CONTENT.purposesTitle}
              </p>
            ...
            <div className="mt-4">
              <p className="font-semibold text-text-default">
                ■ {CONSENT_CONTENT.retentionTitle}
              </p>
